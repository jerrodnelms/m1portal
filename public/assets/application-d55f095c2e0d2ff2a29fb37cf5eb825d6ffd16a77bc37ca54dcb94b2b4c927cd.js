...
(function() {
  jQuery(function() {
    var clinicaccurate, clinicdocs, clinicmisdiagnosed, clinicomitted;
    ...
    $('#clinic_cr_form_clinic_id').change(function() {
      ...
      if (options) {
        return $('#clinic_cr_form_clinic_omitted_condition_id').html(options);
      } else {
        return $('#clinic_cr_form_clinic_omitted_condition_id').empty();
      }
    });
    ...
    $('#clinic_cr_form_clinic_id').change(function() {
      ...
      if (options) {
        return $('#clinic_cr_form_clinic_misdiagnosed_condition_id').html(options);
      } else {
        return $('#clinic_cr_form_clinic_misdiagnosed_condition_id').empty();
      }
    });
    clinicaccurate = $('#clinic_cr_form_clinic_accurate_condition_id').html();
    return $('#clinic_cr_form_clinic_id').change(function() {
      var clinic, options;
      clinic = $('#clinic_cr_form_clinic_id :selected').text();
      options = $(clinicaccurate).filter("optgroup[label='" + clinic + "']").html();
      if (options) {
        return $('#clinic_cr_form_clinic_accurate_condition_id').html(options);
      } else {
        return $('#clinic_cr_form_clinic_accurate_condition_id').empty();
      }
    });
  });
